...
public class InputManager
{
    ...
    private void SetKeyAxis()
    {
        ...
        if (Input.GetKey(KeyCode.A))
        {
            ...
            KeyAxisX = Mathf.MoveTowards(KeyAxisX, -1, Time.deltaTime * AxisSensitivity);
            isPress = true;
        ...
        if (!isPress)
        {
            KeyAxisX = Mathf.MoveTowards(KeyAxisX, 0, Time.deltaTime * AxisSensitivity * 2);
        }
        ...
        if (Input.GetKey(KeyCode.S))
        {
            ...
            KeyAxisY = Mathf.MoveTowards(KeyAxisY, -1, Time.deltaTime * AxisSensitivity);
            isPress = true;
        ...
        if (!isPress)
        {
            KeyAxisY = Mathf.MoveTowards(KeyAxisY, 0, Time.deltaTime * AxisSensitivity * 2f);
        }
    }
